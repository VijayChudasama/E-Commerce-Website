<div>
    <div class="footer-area"  style="background-color: {{ $appSetting->color ?? '' }}">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <a href="https://mail.google.com/mail/u/0/#inbox?compose=new" class="text-white">
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class=""> &copy; 2023 - VijayCard - Ecommerce. All rights reserved.</p>
                </div>
                <div class="col-md-6">
